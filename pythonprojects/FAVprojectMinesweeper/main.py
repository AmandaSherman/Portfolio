...
class Board:
    ...
    def assign_values_to_board(self):
        # assign a number 0-8 for all the empty spaces, which
    ...
    def __str__(self):
        # if you call print on this object, print out what this function returns!
        # return a string that shows the board to the player
        # create a new array that represents what the user would see
        visible_board = [
            [str(self.board[row][col]) if (row, col) in self.dug else ' ' for col in range(self.dim_size)]
        ...
        for idx in range(self.dim_size):
            ...
            widths.append(max(map(len, columns)))
